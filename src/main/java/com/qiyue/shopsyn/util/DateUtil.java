...
public class DateUtil {
    ...
    public static final String DiATE_YYYY_MM_DD_PATTERN = "yyyy-MM-dd HH:mm:ss.S";
    ...
    public static Long parseDateToLang(String pattern, String dateStr) {
...
//		startDate = sdf.format(c.getTime());
     ...
     * @return 两个时间差
     */
    public static double getTimeDiss(Date beginTime, Date endTime) {
        ...
        return hour + bigDecimal2.doubleValue();
    }
    ...
    public static int getMinuteBetween(Date startDate, Date endDate) {
        ...
        try {
            ...
            long startTimes = startDate.getTime();
            long endTimes = endDate.getTime();
            betweenDays = (endTimes - startTimes) / (60 * 1000);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return betweenDays.intValue();
    ...
    /**
     * 获取传入日期第一秒 格式 yyyy-MM-dd HH:mm:ss
     *
     * @return
     */
...
//        String s = dateToString(DATE_YYYYMMDD_PATTERN, new Date());
//        System.out.println(s);
